...
ActiveRecord::Schema.define(:version => 20120429101241) do
  ...
  create_table "parent_contact_details", :force => true do |t|
    t.string   "name"
    t.string   "phone"
    t.integer  "user_id"
    t.datetime "created_at", :null => false
  ...
  create_table "sc_classes", :force => true do |t|
    t.string   "name"
    t.string   "description"
    t.integer  "institute_id"
    t.datetime "created_at",   :null => false
  ...
  create_table "sc_sections", :force => true do |t|
    t.string   "name"
    t.string   "description"
    t.integer  "sc_class_id"
    t.datetime "created_at",  :null => false
